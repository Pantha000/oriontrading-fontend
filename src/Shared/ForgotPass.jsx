        ...
        <div className="font-[sans-serif] text-[#333] bg-white md:h-screen p-4">
            ...
            <div className="grid grid-cols-2 justify-center items-center gap-8">
                <form className="max-w-md w-full mx-auto">
                    <div className="mb-12">
                        <h3 className=" text-primary text-center text-4xl font-extrabold">Forgot your password</h3>
                    ...
                    <div className='bg-bg2 p-8 rounded-3xl'>
                        ...
                        <div className="mt-8">
                            ...
                            <div className="relative flex items-center">
                                <input name="password" type="password" required className="w-full bg-bg2 text-sm border-b border-gray-300 focus:border-blue-600 px-2 py-3 outline-none" placeholder="Enter password" />
                        ...
                        <div className="mt-12 grid justify-center">
                            <button onClick={handleForgot} type="button" className="w-full  shadow-xl py-2.5 px-4 text-sm font-semibold rounded-full text-white bg-primary hover:bg-blue-700 focus:outline-none">
                                {loading?"Loading...":"Forgot Password"}
                            </button>
                            <p className="text-sm text-center mt-8">Back to  <Link to='/login' className="text-primary font-semibold hover:underline ml-1 whitespace-nowrap">login</Link></p>
                        </div>
                    </div>
