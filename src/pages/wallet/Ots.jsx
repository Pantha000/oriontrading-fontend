                        ...
                        <div className="relative bg-white rounded-lg shadow dark:bg-gray-700">
                            ...
                            <div className="p-4 md:p-5 text-center">
                                ...
                                <div>
                                    ...
                                    <h1 className='text-center'>Current Balance {user?.fundingBalance.toFixed(2)} USDT</h1>
                                    <div className='grid gap-2 my-5'>
                                        <p className='text-start'>Transfer to</p>
                                        <input onChange={(e)=>setReciver(e.target.value)} className="mb-2 appearance-none border rounded py-2 focus:shadow-outline" id="amount" type="text" placeholder="User ID" />
                                        <p className='text-start'>Amount</p>
                                        <input onChange={(e)=>setAmount(e.target.value)} className="appearance-none border rounded py-2 focus:shadow-outline" id="amount" type="text" placeholder="Enter amount" />
                                    </div>
                                    <p className='text-start pb-5'>Service charge 0.00 USD</p>
                                </div>
                                <button onClick={handleTransfer} data-modal-hide="popup-modal" type="button" className="text-white bg-primary rounded-xl hover:bg-red-800 focus:ring-4 focus:outline-none focus:ring-red-300 font-medium text-sm inline-flex items-center px-5 py-2.5 text-center">
