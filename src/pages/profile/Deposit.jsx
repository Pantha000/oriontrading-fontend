        ...
        <div className="ml-12 mt-16 w-6/12">
            <div className="flex justify-around">
                <div className="mr-2">
                    ...
                    <input onChange={(e)=>setAmount(e.target.value)} className="border-[1px] border-[#CB0881] px-4 py-[6.9px] rounded-md mt-1" type="text" placeholder="Type Amount"/>
                </div>
                <div className="mr-2">
                    <label className="text-md font-semibold">Transaction ID</label>
                    <input onChange={(e)=>setTrxId(e.target.value)} className="border-[1px] border-[#CB0881] px-4 py-[6.9px] rounded-md mt-1" type="text" placeholder="Type Your TxID"/>
                </div>
                <div className="mr-2">
                    <label className="text-md font-semibold">Transaction Proof</label>
                    <input onChange={chooseProof} name="deposit" className="border-[1px] border-[#CB0881] px-4 py-1 rounded-md mt-1" type="file" placeholder="Type Your TxID"/>
                </div>
            </div>
            <div className="mt-5">
                <button onClick={handleDeposit} className="px-10 py-2 bg-[#CB0881] rounded-full text-white font-medium">{loading?"Loading...":"Submit Request"}</button>
