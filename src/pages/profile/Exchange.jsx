...
const Exchange = () => {
  ...
  return (
    <div className="container mx-auto pt-28 pb-12 px-5 lg:px-0">
           ...
           <div className="flex items-start">
                ...
                <div>
                    ...
                    <div className="flex items-center mt-10">
                        ...
                        <p className="text-sm lg:text-lg">Lorem ipsum dolor sit amet, consectetur et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exerco</p>
                    </div>
        ...
        <div className=" w-full lg:w-9/12 flex flex-col lg:flex-row items-center mt-10">
           <div className="mr-0 lg:mr-5 w-full lg:w-6/12">
           ...
           <div className="mr-0 lg:mr-5 mt-4 lg:mt-0 cursor-pointer">
                <img src={swap}/>
           </div>
        ...
        <div className="ml-12 mt-16 w-full lg:w-6/12">
            <div className="mt-5">
